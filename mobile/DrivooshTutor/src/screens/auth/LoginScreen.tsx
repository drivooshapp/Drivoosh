...
// //
//       if (role === 'user') {
//         Alert.alert('אין הרשאה', 'הגישה לאפליקציה זו מוגבלת למורים בלבד. החשבון שלך מזוהה כתלמיד. אנא התחבר דרך אפליקציית התלמידים.');
//         return;
//       }
        ...
        <View style={styles.content}>
          <View style={styles.headerContainer}>
            <Image
              ...
              resizeMode="contain"
            />
            <Text style={styles.title}>התחברות - מורה</Text>
            <Text style={styles.subtitle}>התחבר לחשבון שלך כדי להמשיך</Text>
          </View>
